...
\def\TitleFont{\Large\bfseries}             % font format for thesis title
...
\def\TitleTopOffset{30}                     % combined HederHeight + HeaderSpace 
...
\newcommand{\thesistitle}[1]{{\TitleFont \MakeUppercase{#1} \par}}
\newcommand{\thesisauthor}[1]{by \\ #1 \\}
\newcommand{\location}{Baltimore, Maryland}
\newcommand{\thesisdate}[2]{#1 #2}
\newcommand{\thesiscopyright}[2]{\copyright\ {#1} {#2} \\ All rights reserved}
...
%%%% modified macros/ commands for ToC, LoF, LoT
