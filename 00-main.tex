...
%% if you have a longer quote, you can change it or break the quote in multiple lines
...
%%%% following numbers are found by trial and error to compensate for spacing 
%% around default LaTeX environments 
...
%% use a citation manager program to generate the BibLaTeX file (not BibTeX)
%% change the style or other options if you need to (google is your friend)
...
\usepackage{\FontPackage}                               % load font package
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% following section is needed if the EPIGRAPH package is used for quotes.
%% epigraph examples given in chapters 2 and 3 for relatively small quotes.
%% for longer quotes, break it down in multiple lines with line break and put
...
%% you can add more listing environments here (optional)
