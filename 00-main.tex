...
\usepackage{color,xcolor}                   % color related packages
...
\usepackage{geometry}                       % managing margins
...
\MainTextSpacing                        % restore double spacing in chapter contents
