...
% place the above comment based on where you want to start line numbering

%% remember most content on title page has to be single-spaced
\include{01-title}                          % include the title page
...
\fancyhead[L]{\nouppercase \leftmark}       % avoiding upper-case in the header
...
%% add abstract, dedication, and acknowledgment (and any other front matter here)
\include{02-abstract}
...
{%% local hyperref setting to appear ToC black but hyperlinked
%% you can comment it to have default blue color ToC
