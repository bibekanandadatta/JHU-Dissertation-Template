...
%% hopefully the following settings work for you (examples given in chapters)
...
\doublespacing                          % double spacing for the contents
...
%% references
\clearpage
\singlespacing      % single spacing for the bib items (looks too spread out in double)
