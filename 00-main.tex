...
\def\PrintingOffset{0.5in}                  % additional space on the left margin for print copy
...
\usepackage{comment}                        % to comment large amount of text as env
...
{%% a local hyperref settings to appear TOC black but hyperlinked
...
%% you can write it as other chapters and add the chapter in here as before
%% of if you already have CV as a PDF, add it to the main directory, and use:
